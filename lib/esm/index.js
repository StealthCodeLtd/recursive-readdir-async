...
function read(rpath, data, settings, deep, resolve, reject) {
    FS.readdir(rpath, 'buffer', function (error, files) {
        var _a;
        ...
        if (error) {
            ...
            let checkExt = false;
            if ((settings === null || settings === void 0 ? void 0 : settings.include) !== undefined && settings.include.length !== 0)
                checkExt = true;
            // Iterate through elements (files and folders)
            for (const file of files) {
                const ext = PATH.extname(file.toString());
                if (((_a = settings === null || settings === void 0 ? void 0 : settings.include) === null || _a === void 0 ? void 0 : _a.includes(ext)) || ext.length === 0 || checkExt === false) {
